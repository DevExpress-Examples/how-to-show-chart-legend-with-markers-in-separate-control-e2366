...
Namespace LegendMarkers
	Partial Public Class frmMain
		...
		Private Sub InitializeComponent()
			...
			Dim seriesPoint1 As New DevExpress.XtraCharts.SeriesPoint("1", New Object() { (CObj(1R)), (CObj(2R))})
			Dim seriesPoint2 As New DevExpress.XtraCharts.SeriesPoint("2", New Object() { (CObj(2R)), (CObj(3R))})
			Dim seriesPoint3 As New DevExpress.XtraCharts.SeriesPoint("3", New Object() { (CObj(3R)), (CObj(4R))})
			Dim overlappedRangeBarSeriesView1 As New DevExpress.XtraCharts.OverlappedRangeBarSeriesView()
			Dim series2 As New DevExpress.XtraCharts.Series()
			Dim seriesPoint4 As New DevExpress.XtraCharts.SeriesPoint("1", New Object() { (CObj(2R))})
			Dim seriesPoint5 As New DevExpress.XtraCharts.SeriesPoint("2", New Object() { (CObj(3R))})
			Dim seriesPoint6 As New DevExpress.XtraCharts.SeriesPoint("3", New Object() { (CObj(1R))})
			Dim areaSeriesView1 As New DevExpress.XtraCharts.AreaSeriesView()
			Dim series3 As New DevExpress.XtraCharts.Series()
			Dim seriesPoint7 As New DevExpress.XtraCharts.SeriesPoint("1", New Object() { (CObj(1R))})
			Dim seriesPoint8 As New DevExpress.XtraCharts.SeriesPoint("2", New Object() { (CObj(2R))})
			Dim seriesPoint9 As New DevExpress.XtraCharts.SeriesPoint("3", New Object() { (CObj(3R))})
			Dim series4 As New DevExpress.XtraCharts.Series()
			Dim seriesPoint10 As New DevExpress.XtraCharts.SeriesPoint("1", New Object() { (CObj(3R))})
			Dim seriesPoint11 As New DevExpress.XtraCharts.SeriesPoint("2", New Object() { (CObj(1R))})
			Dim seriesPoint12 As New DevExpress.XtraCharts.SeriesPoint("3", New Object() { (CObj(2R))})
			Dim lineSeriesView1 As New DevExpress.XtraCharts.LineSeriesView()
			Dim series5 As New DevExpress.XtraCharts.Series()
			Dim seriesPoint13 As New DevExpress.XtraCharts.SeriesPoint("1", New Object() { (CObj(1R))})
			Dim seriesPoint14 As New DevExpress.XtraCharts.SeriesPoint("2", New Object() { (CObj(2R))})
			Dim seriesPoint15 As New DevExpress.XtraCharts.SeriesPoint("3", New Object() { (CObj(1R))})
